...
class Game {
	...
	drawBoard(board) {
		...
		if (!this.gameOver) {
			...
			document.getElementById("player_info").innerText = (this.currentPlayer === 0) ? "Waiting on Player 2 to join \"" + formattedGameID + "\"" : (this.currentPlayer == PLAYER_1) ? "Player 1 Go" : "Player 2 Go";
		} else {
